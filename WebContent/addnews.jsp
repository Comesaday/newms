...
<body>
	<div id="container">
		<div class="content">
			<form action="newsservlet?flag=add" name="addnew" method="post">
				<table>		
					<tr>
					...
					<tr>
						<td><input type="text" name="detail" placeholder="请输入新闻简介"></td>
					</tr>
					<tr>
						<td>
							<select name="kind">
					...
					<tr>
						<td>
							<textarea id="myEditor" name="content" style="width:100%; height:570px;" ></textarea>
						</td>
					</tr>
					<tr>
						<td>
